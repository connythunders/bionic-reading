...
const sections = [
  {
    ...
    description: "Spela in dig själv och få direkt AI-feedback på uttal, flyt och innehåll.",
  },
  {
    icon: BookOpen,
    label: "Reading",
    ...
    description: "Autentiska texter med frågor på rätt nivå och format – precis som det riktiga provet.",
  },
  {
    icon: Headphones,
    label: "Listening",
    ...
    description: "AI-genererat brittiskt tal simulerar provsituationen – lyssna och svara på frågor.",
  },
  {
    icon: PenLine,
    label: "Writing",
    ...
    description: "Skrivuppgifter med AI-återkoppling på språk, struktur och innehåll.",
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="hero-gradient pt-20 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-4 leading-tight">
            ...
            <br />
            <span className="text-teal-500">Provet</span>
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
            Öva på alla delar av det nationella provet i engelska med interaktiva uppgifter
            och AI-handledning. Anpassat till Skolverkets format och Lgr22.
          </p>

          <div className="flex items-center justify-center gap-2 text-sm text-gray-500 mb-10">
            <Users className="w-4 h-4" />
            <span>Designad för elever i Åk 9 som vill prestera sitt bästa</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Nationella provet i engelska för Åk 9 består av fyra delprov. Öva på dem
              i valfri ordning.
            </p>
          </div>
      ...
      <section id="om" className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Om Nationella Provet</h2>
            <p className="text-gray-600">
              Vad bedöms i varje delprov enligt Skolverkets riktlinjer?
            </p>
          </div>
            ...
            {[
              {
                ...
                items: [
                  ...
                  "Uttal, prosodi och flyt",
                  "Ordförråd och grammatisk korrekthet",
                  "Anpassning till situation och mottagare",
                ],
              },
              {
                title: "Delprov B1 – Reading",
                color: "border-l-blue-500",
                items: [
                  "Förståelse av autentiska texter",
                  "Identifiera huvudbudskap och detaljer",
                  "Tolka underförstådd information",
                  "Texter på B1–B2 nivå (CEFR)",
                ],
              },
              {
                title: "Delprov B2 – Listening",
                color: "border-l-teal-500",
                items: [
                  "Förståelse av talat engelska",
                  "Brittiska och nordamerikanska accenter",
                  "Konversationer, monologer och intervjuer",
                  "Identifiera ståndpunkter och attityder",
                ],
              },
              {
                title: "Delprov C – Writing",
                color: "border-l-orange-500",
                items: [
                  "Skriftlig produktion och interaktion",
                  "Innehåll, struktur och sammanhang",
                  "Ordförråd och grammatisk variation",
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white">NP Engelska</span>
          </div>
          <p className="text-sm text-center">
            Anpassad till Skolverkets kursplan för Lgr22 · Engelska Åk 9
          </p>
