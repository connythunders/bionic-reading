...
export default function ReadingPage() {
  ...
  const levelColors: Record<string, string> = {
    ...
    "B2-C1": "bg-purple-100 text-purple-700",
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900">Reading – Delprov B</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sticky top-20">
                ...
                <button
                  ...
                  className="mt-4 w-full bg-violet-600 text-white py-2.5 rounded-xl font-semibold hover:bg-violet-700 transition-colors text-sm"
                >
                  Gå till frågorna →
                </button>
              </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-violet-50 rounded-lg p-2.5 text-xs text-violet-700">
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
      ...
      {question.type === "short-answer" && (
        <textarea
          ...
          rows={3}
          className="w-full border border-gray-200 rounded-lg p-2 text-sm text-gray-700 resize-none focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-400"
        />
      )}
    </div>
  );
