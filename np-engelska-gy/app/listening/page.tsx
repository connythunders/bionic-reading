...
export default function ListeningPage() {
  ...
  const levelColors: Record<string, string> = {
    ...
    "B2-C1": "bg-fuchsia-100 text-fuchsia-700",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-fuchsia-500 rounded-lg flex items-center justify-center">
              <Headphones className="w-4 h-4 text-white" />
            </div>
            <span className="font-semibold text-gray-900">Listening – Delprov C</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {/* Track info */}
        <div className="bg-white rounded-2xl border border-fuchsia-100 shadow-sm p-6 mb-6">
        ...
        {phase === "intro" && (
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  <Volume2 className="w-4 h-4 text-fuchsia-500 mt-0.5 flex-shrink-0" />
            ...
            <button
              ...
              className="w-full bg-fuchsia-600 text-white py-4 rounded-2xl font-semibold text-lg hover:bg-fuchsia-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-3 shadow-sm"
            >
              {isLoadingAudio ? (
                <>
        ...
        {phase === "listening" && (
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-fuchsia-200 shadow-sm p-8 text-center">
              <div className="mb-4">
                <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto shadow-lg ${isPlaying ? "bg-fuchsia-500" : "bg-gray-200"}`}>
              ...
              {isPlaying && (
                <div className="flex items-center justify-center gap-1 mb-3">
                  {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div
                      key={i}
                      className="wave-bar w-1.5 bg-fuchsia-400 rounded-full"
              ...
              <div className="flex justify-center gap-3">
                <button
                  ...
                  className="flex items-center gap-2 bg-fuchsia-600 text-white px-6 py-2.5 rounded-xl font-medium hover:bg-fuchsia-700 transition-colors"
                >
            ...
            {hasListened && (
              <button
                ...
                className="w-full bg-fuchsia-600 text-white py-3 rounded-2xl font-semibold hover:bg-fuchsia-700 transition-colors"
              >
                Gå till frågorna →
              </button>
            )}
        ...
        {phase === "questions" && (
          <div className="space-y-4">
            <div className="bg-fuchsia-50 rounded-xl border border-fuchsia-200 p-4 flex items-center justify-between">
              <p className="text-sm text-fuchsia-700 font-medium">{track.title}</p>
              {playCount < 2 && (
                <button
                  onClick={replayAudio}
                  className="text-xs text-fuchsia-600 hover:text-fuchsia-800 flex items-center gap-1.5 border border-fuchsia-300 rounded-lg px-3 py-1.5 bg-white transition-colors"
                >
              ...
              <div key={q.id} className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
                    ...
                    {q.options.map((opt, i) => (
                      <button
                        ...
                        className={`w-full text-left text-sm px-3 py-2 rounded-lg border transition-colors ${
                          answers[q.id] === i
                            ? "border-fuchsia-500 bg-fuchsia-50 text-fuchsia-800 font-medium"
                            : "border-gray-200 hover:border-fuchsia-300 hover:bg-fuchsia-50 text-gray-700"
                        }`}
                      >
                        {opt}
                      </button>
                ...
                {q.type === "short-answer" && (
                  <textarea
                    ...
                    rows={2}
                    className="w-full border border-gray-200 rounded-lg p-2 text-sm resize-none focus:outline-none focus:border-fuchsia-400 focus:ring-1 focus:ring-fuchsia-400"
                  />
                )}
              </div>
            ))}
            ...
            <button
              ...
              disabled={!mcAnswered}
              className="w-full bg-fuchsia-600 text-white py-3 rounded-xl font-semibold hover:bg-fuchsia-700 transition-colors disabled:opacity-50"
            >
              Skicka in svar
            </button>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-fuchsia-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-center">
                  <div className="text-4xl font-black text-fuchsia-600">{score}/{mcTotal}</div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-fuchsia-50 rounded-lg p-2.5 text-xs text-fuchsia-700">
            ...
            <div className="flex gap-3">
              ...
              {trackIndex < listeningTracks.length - 1 && (
                <button
                  ...
                  className="flex-1 bg-fuchsia-600 text-white py-3 rounded-xl font-semibold hover:bg-fuchsia-700 transition-colors flex items-center justify-center gap-2"
                >
