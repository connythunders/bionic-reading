...
const MODE_STYLE: Record<Mode, StyleSpec> = {
  ...
  bus:       { coreRadius: 0.03, glowRadius: 0.12, coreOpacity: 0.70, glowOpacity: 0.04, emissiveIntensity: 1.0, segmentsPerUnit: 2.0 },
};

function ModeLine({ curve, color, length, mode }: { curve: THREE.Curve<THREE.Vector3>; color: string; length: number; mode: Mode }) {
